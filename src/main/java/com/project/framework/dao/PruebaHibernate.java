...
//            Continente continente = (Continente) session.get(Continente.class, 2);
//            System.out.println(continente.getTexto());
//        } catch(Exception e) {
//            e.printStackTrace();
//        } finally {
...
//        }
        ...
        try {
            Continente c = new Continente(3, "africa");
            ContinenteDAOImpl cdi = new ContinenteDAOImpl();
            cdi.addContinente(c);
            System.out.println("CONTINENTE AÑADIDO A LA BASE DE DATOS");
        }catch(Exception e) {
            e.printStackTrace();
        }
        }
