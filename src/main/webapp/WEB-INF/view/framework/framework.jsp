...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<spring:url value="/webjars/bootstrap/3.3.7/css/bootstrap-theme.min.css" />" />
        <link rel="stylesheet" href="<spring:url value="/webjars/font-awesome/4.7.0/css/font-awesome.min.css" />" />
        ...
        <script src="<spring:url value="/webjars/jquery/1.12.4/jquery.min.js" />"></script>
        ...
        <nav class="navbar navbar-project navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://localhost:8084/Project/framework.htm">PROJECT</a>
                </div>
